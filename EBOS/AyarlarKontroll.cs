...
namespace EBOS
{
    public partial class AyarlarKontroll : UserControl
    {
        ...
        private void ArayuzOlustur()
        {
            ...
            btnYesil.Click += (s, e) => { YoneticiPaneli.AktifTema = "Yesil"; if (this.FindForm() is YoneticiPaneli panel) { panel.ApplyTheme(); } };
            ...
            btnLacivert.Click += (s, e) => { YoneticiPaneli.AktifTema = "Lacivert"; if (this.FindForm() is YoneticiPaneli panel) { panel.ApplyTheme(); } };
            ...
            btnKoyu.Click += (s, e) => { YoneticiPaneli.AktifTema = "Koyu"; if (this.FindForm() is YoneticiPaneli panel)
                {
                    panel.ApplyTheme();
                }
            };
